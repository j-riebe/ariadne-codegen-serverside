...
def resolve__issue__text(obj: str, info: GraphQLResolveInfo) -> str:
    # obj should be of type Issue
    return obj


def resolve__issue__parent(obj: Issue, info: GraphQLResolveInfo) -> str:
    # return type should be Optional[Issue]
    return "Unknown"
